    ...
    def _build_run_config(self) -> Dict[str, Any]:
        ...
        if self.enhancement_json_path:
            ...
            if load_enhancement_data(self.enhancement_json_path):
                ...
                hook_config = {"class": "sweagent.agent.hooks.intelligent_guidance_hook.IntelligentGuidanceHook"}
...
def main():
    ...
    parser.add_argument(
        "--enhance-history-filter-json", type=str, help="Path to enhancement data JSON file for intelligent guidance"
    )
